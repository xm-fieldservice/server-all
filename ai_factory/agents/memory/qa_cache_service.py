        ...
        with self._get_connection() as conn:
            with conn.cursor() as cur:
                ...
                """, (qa_id, user_id, assistant_id, tenant_id, normalized_question,
                       question_embedding, answer_entry_id, answer_type.value,
        ...
        with self._get_connection() as conn:
            with conn.cursor() as cur:
                ...
                cur.execute("""
                    ...
                    LIMIT %s
                """, (question_embedding, user_id, assistant_id, tenant_id,
                      QAStatus.ACTIVE.value, question_embedding, threshold, limit))
                ...
                return [
                    QAInfo(
                        ...
                        quality_score=self._parse_quality_score(row[10]),
