...
RAISE NOTICE '缺失表创建完成';

-- ============================================================
-- 2. 升级 chat_sessions 表
-- ============================================================
DO $$
BEGIN
    -- 添加 agent_type 字段
...
-- ============================================================
-- 5. 升级 entries 表（添加 Knowledge Node 四级结构字段）
-- ============================================================
DO $$
BEGIN
    -- 四层数据隔离字段（V3新增）
