...
| 文档 | 说明 |
|------|------|
| [需求规格文档_v1.0.md](./需求规格文档_v1.0.md) | 传统需求文档 |
| [三维需求图谱_v1.0.md](./三维需求图谱_v1.0.md) | 三维需求体系框架 |
| [模块详情_M3_脑图模块_v1.0.md](./模块详情_M3_脑图模块_v1.0.md) | 脑图模块详细描述 |
...
| M4 | 项目管理框架 | 核心业务 | 规划中 | 人工→半自动→全自动演进 |
